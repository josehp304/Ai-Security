  ...
  return (
    <>
      ...
      <div className="relative bg-[url('/background.jpg')] bg-cover bg-fixed bg-center min-h-screen w-full m-0">
        {/* Dark overlay */}
        <div className="absolute inset-0 bg-gradient-to-br from-black/80 via-black/70 to-blue-900/50"></div>

    <nav className="relative z-10 flex justify-between items-center px-6 py-5 text-white">
      {/* Logo */}
      ...
      <div
        className={`absolute top-full left-0 w-full bg-black/90 md:hidden overflow-hidden transition-all duration-500 ease-in-out ${
...
<section id="applications" className="py-24 px-6 bg-gradient-to-b from-gray-900 via-black to-gray-900 relative overflow-hidden">
  {/* Background Pattern */}
  ...
  <div className="relative z-10 max-w-7xl mx-auto">
    <div className="text-center mb-16">
      ...
      <h2 className="text-5xl md:text-6xl font-bold mt-6 mb-8 bg-gradient-to-r from-white via-blue-100 to-blue-200 bg-clip-text text-transparent">
    ...
    <div className="grid md:grid-cols-2  gap-12 md:gap-30">
      ...
      <div>
        ...
        <ul className="space-y-4">
          <li>
            <a href="#applications" className="text-gray-400 hover:text-blue-400 transition-colors duration-300 flex items-center gap-2">
